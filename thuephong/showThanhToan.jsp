                ...
                <%@ include file="../main/main.jsp" %>
                    <table>
                        ...
                        <tbody>
                            <%
                            String role="no";
                        ResultSet seenRoom = stmt.executeQuery("SELECT * FROM `tt_thuephong` INNER JOIN sinhvien on sinhvien.MaSV=tt_thuephong.MaSV INNER JOIN lop on lop.MaLop=sinhvien.MaLop WHERE ThanhToan='no';");
                        while (seenRoom.next()) {
                            %>
                                <tr>
